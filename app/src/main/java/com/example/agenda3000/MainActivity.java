package com.example.agenda3000;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tela1() {
        ...
        btCadastrar = findViewById(R.id.btCad);
        btListar = findViewById(R.id.btList);
    ...
    public void tela2() {
        ...
        btLimparCad = findViewById(R.id.btLimparCad);
        btFecharCad = findViewById(R.id.btFecharCad);
        etNomeCad = findViewById(R.id.etQuest1);
        etFoneCad = findViewById(R.id.etQuest2);
        etEndeCad = findViewById(R.id.etQuest3);
    ...
    public void tela3() {
        setContentView(R.layout.telalistagem);
